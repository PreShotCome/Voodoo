...
| VPN silently disconnected | Proton-required scopes fail closed on adapter detection | Adapter presence is not cryptographic proof of egress; v0.1 reports this honestly |
...
| Destructive false positive | v0.1 never quarantines or changes host settings | Operator remediation is manual |
