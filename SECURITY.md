...
live credentials, private logs, customer data, or weaponized proof-of-concept
code in a public issue. A useful report includes the affected version, operating
system, reproduction steps using synthetic data, impact, and a proposed fix if
known.
